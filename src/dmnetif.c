...
dmod_dmnetif_api_declaration(1.0, dmnetif_t, _create, ( void ))
{
    ...
    struct dmnetif *instance = Dmod_Malloc(sizeof(*instance));
    if (instance == NULL)
    {
        return NULL;
    }
...
dmod_dmnetif_api_declaration(1.0, void, _destroy, ( dmnetif_t handle ))
{
    Dmod_Free(handle);
}

dmod_dmnetif_api_declaration(1.0, bool, _is_valid, ( dmnetif_t handle ))
{
